...
let modulePaths = {
 ...
 "packages/LePetitLyonnais/dashboard": "packages/LePetitLyonnais/dashboard.ddc",
 "packages/LePetitLyonnais/login/google": "packages/LePetitLyonnais/login/google.ddc",
 "packages/LePetitLyonnais/login/login": "packages/LePetitLyonnais/login/login.ddc",
 "packages/LePetitLyonnais/login/signin": "packages/LePetitLyonnais/login/signin.ddc",
 "packages/LePetitLyonnais/login/signup": "packages/LePetitLyonnais/login/signup.ddc",
 "packages/LePetitLyonnais/main": "packages/LePetitLyonnais/main.ddc",
 "packages/LePetitLyonnais/main_web_entrypoint": "packages/LePetitLyonnais/main_web_entrypoint.ddc",
 "packages/LePetitLyonnais/widgets/finance": "packages/LePetitLyonnais/widgets/finance.ddc",
 "packages/LePetitLyonnais/widgets/meteo": "packages/LePetitLyonnais/widgets/meteo.ddc",
 "packages/LePetitLyonnais/widgets/rpicture": "packages/LePetitLyonnais/widgets/rpicture.ddc",
...
define("main_web_entrypoint.dart.bootstrap", ["packages/LePetitLyonnais/main_web_entrypoint", "dart_sdk"], function(app, dart_sdk) {
  ...
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        ...
        if (childName === "package:LePetitLyonnais/main_web_entrypoint.dart") {
          // Clear static caches.
