...
let modulePaths = {
 ...
 "packages/LePetitLyonnais/widgets/meteo_web_entrypoint": "packages/LePetitLyonnais/widgets/meteo_web_entrypoint.ddc",
...
if(!window.$dartLoader) {
   window.$dartLoader = {
     appDigests: _currentDirectory + 'meteo_web_entrypoint.digests',
...
define("meteo_web_entrypoint.dart.bootstrap", ["packages/LePetitLyonnais/widgets/meteo_web_entrypoint", "dart_sdk"], function(app, dart_sdk) {
  ...
  (app.lib__widgets__meteo_web_entrypoint || app.meteo_web_entrypoint).main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        ...
        if (childName === "package:LePetitLyonnais/widgets/meteo_web_entrypoint.dart") {
          // Clear static caches.
  ...
  dart_sdk.dart.trackLibraries("meteo_web_entrypoint.dart.bootstrap", {
    "meteo_web_entrypoint.dart.bootstrap": bootstrap
  }, '');
  return {
    bootstrap: bootstrap
  };
