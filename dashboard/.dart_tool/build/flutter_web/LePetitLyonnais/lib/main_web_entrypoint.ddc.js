define(['dart_sdk', 'packages/LePetitLyonnais/main'], function(dart_sdk, packages__LePetitLyonnais__main) {
  'use strict';
  ...
  const main = packages__LePetitLyonnais__main.main;
  ...
  dart.trackLibraries("packages/LePetitLyonnais/main_web_entrypoint", {
    "package:LePetitLyonnais/main_web_entrypoint.dart": main_web_entrypoint
  }, {
