define(['dart_sdk', 'packages/flutter/src/widgets/actions', 'packages/flutter/src/painting/_network_image_web'], function(dart_sdk, packages__flutter__src__widgets__actions, packages__flutter__src__painting___network_image_web) {
  ...
  dart.defineLazy(CT, {
    ...
    get C0() {
      return C0 = dart.const({
        ...
        [_Location_column]: 18,
        [_Location_line]: 16,
        [_Location_file]: "org-dartlang-app:///packages/dashboard/widgets/rpicture.dart"
      });
    },
    get C8() {
  ...
  dart.setLibraryUri(rpicture.Rpictures, "package:dashboard/widgets/rpicture.dart");
  ...
  rpicture._RpicturesState = class _RpicturesState extends framework.State$(rpicture.Rpictures) {
    ...
    [_newImage]() {
      this.setState(dart.fn(() => {
        this[_imageurl] = "https://source.unsplash.com/random/" + dart.str(this.counter);
  ...
  dart.setLibraryUri(rpicture._RpicturesState, "package:dashboard/widgets/rpicture.dart");
  ...
  dart.trackLibraries("packages/dashboard/widgets/rpicture", {
    "package:dashboard/widgets/rpicture.dart": rpicture
  }, {
  }, '{"version":3,"sourceRoot":"","sources":["rpicture.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AAMmC;IAAiB;;;QAHnC;;AAAQ,sDAAW,GAAG;;EAAC;;;;;;;;;;;;;;;;;;;;;;;;;;AAYpC,YAAa,yBACX,uBACY;IAIhB;;AAMI,MAHF,cAAS;AACkD,QAAzD,kBAAY,AAA6C,iDAAR;AACxC,QAAT,eAAO,aAAP,gBAAO;;IAEX;UAG0B;AACxB,YAAO,kDACY,uCACA;IAErB;;;IAzBI,kBAAY;IACZ,eAAU;;;EAyBhB","file":"rpicture.ddc.js"}');
  // Exports:
  return {
