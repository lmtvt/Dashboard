define(['dart_sdk', 'packages/flutter/src/widgets/actions', 'packages/http/http', 'packages/flutter/material'], function(dart_sdk, packages__flutter__src__widgets__actions, packages__http__http, packages__flutter__material) {
  ...
  dart.defineLazy(CT, {
    ...
    get C0() {
      return C0 = dart.const({
        ...
        [_Location_column]: 9,
        [_Location_line]: 39,
        [_Location_file]: "org-dartlang-app:///packages/dashboard/widgets/finance.dart"
      });
    },
    get C5() {
  ...
  dart.setLibraryUri(finance.Finance, "package:dashboard/widgets/finance.dart");
  ...
  dart.setLibraryUri(finance._FinanceState, "package:dashboard/widgets/finance.dart");
