...
let modulePaths = {
 ...
 "packages/dashboard/dashboard": "packages/dashboard/dashboard.ddc",
 "packages/dashboard/login/login": "packages/dashboard/login/login.ddc",
 "packages/dashboard/login/signin": "packages/dashboard/login/signin.ddc",
 "packages/dashboard/login/signup": "packages/dashboard/login/signup.ddc",
 "packages/dashboard/main": "packages/dashboard/main.ddc",
 "packages/dashboard/main_web_entrypoint": "packages/dashboard/main_web_entrypoint.ddc",
 "packages/dashboard/widgets/finance": "packages/dashboard/widgets/finance.ddc",
 "packages/dashboard/widgets/rpicture": "packages/dashboard/widgets/rpicture.ddc",
...
define("main_web_entrypoint.dart.bootstrap", ["packages/dashboard/main_web_entrypoint", "dart_sdk"], function(app, dart_sdk) {
  ...
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        ...
        if (childName === "package:dashboard/main_web_entrypoint.dart") {
          // Clear static caches.
